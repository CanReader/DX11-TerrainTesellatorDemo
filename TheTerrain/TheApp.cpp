...
TheApp::TheApp() : m_Terrain(nullptr), m_TessellationShader(nullptr) {
}

void TheApp::init(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight, Input *in)
{
